...
import com.vst.defend.dao2.user.VstUserAddChannelVersionDao;
 ...
 * 
 * @author lhp
 * @date 2018-1-3 下午07:50:03
 * @version
 */
@Service
public class VstUserAddChannelVersionServiceImpl implements VstUserAddChannelVersionService {
	/**
	 * 写日志
	 */
	 ...
	 */
	@Resource
	private VstUserAddChannelVersionDao _vstUserAddChannelVersionDao;
	...
	public ReportBean getExportData(Map<String, Object> params, UserSession user) throws SystemException {
		...
		try{
			...
			List<Map<String, Object>> data = _vstUserAddChannelVersionDao.queryExport(params);
			...
			bean.setTitle("vst_user_add_channel_version_data");
			...
			logger.error("导出新增用户(渠道、版本)数据失败: " + SystemException.getExceptionInfo(e));
	...
	public JSONObject getReportByVersion(Map<String, Object> params) throws SystemException {
		...
		try {
			...
			List<Map<String, Object>> list = _vstUserAddChannelVersionDao.queryReportByVersion(params);
