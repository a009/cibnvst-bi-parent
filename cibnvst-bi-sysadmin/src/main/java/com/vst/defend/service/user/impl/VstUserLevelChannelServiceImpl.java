 ...
 * 
 * @author lhp
 * @date 2018-1-5 上午10:49:52
 * @version
 */
@Service
public class VstUserLevelChannelServiceImpl implements VstUserLevelChannelService {
	/**
	 * 写日志
	 */
	private static final Log logger = LogFactory.getLog(VstUserLevelChannelServiceImpl.class);
	...
	public ReportBean getExportData(Map<String, Object> params, UserSession user) throws SystemException {
		...
		try{
			...
			logger.error("导出季质量用户(渠道)数据失败: " + SystemException.getExceptionInfo(e));
