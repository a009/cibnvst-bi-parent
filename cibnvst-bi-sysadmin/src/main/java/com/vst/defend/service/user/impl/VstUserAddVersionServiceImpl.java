...
import com.vst.defend.dao2.user.VstUserAddVersionDao;
 ...
 * 
 * @author lhp
 * @date 2018-1-3 下午04:44:56
 * @version
 */
@Service
public class VstUserAddVersionServiceImpl implements VstUserAddVersionService {
	/**
	 * 写日志
	 */
	private static final Log logger = LogFactory.getLog(VstUserAddVersionServiceImpl.class);
	
	/**
	 * 新增用户(版本)Dao接口
	 */
	@Resource
	private VstUserAddVersionDao _vstUserAddVersionDao;
	...
	public ReportBean getExportData(Map<String, Object> params, UserSession user) throws SystemException {
		...
		try{
			...
			List<Map<String, Object>> data = _vstUserAddVersionDao.queryExport(params);
			...
			bean.setTitle("vst_user_add_version_data");
			...
			logger.error("导出新增用户(版本)数据失败: " + SystemException.getExceptionInfo(e));
