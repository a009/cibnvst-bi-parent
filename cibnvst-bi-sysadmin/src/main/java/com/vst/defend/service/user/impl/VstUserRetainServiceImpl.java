...
import com.vst.defend.dao2.user.VstUserRetainDao;
 ...
 * 
 * @author lhp
 * @date 2018-1-3 下午09:25:29
 * @version
 */
@Service
public class VstUserRetainServiceImpl implements VstUserRetainService {
	/**
	 * 写日志
	 */
	private static final Log logger = LogFactory.getLog(VstUserRetainServiceImpl.class);
	
	/**
	 * 留存用户Dao接口
	 */
	@Resource
	private VstUserRetainDao _vstUserRetainDao;
	...
	public ReportBean getExportData(Map<String, Object> params, UserSession user) throws SystemException {
		...
		try{
			...
			List<Map<String, Object>> data = _vstUserRetainDao.queryExport(params);
			...
			bean.setTitle("vst_user_retain_data");
			...
			logger.error("导出留存用户数据失败: " + SystemException.getExceptionInfo(e));
