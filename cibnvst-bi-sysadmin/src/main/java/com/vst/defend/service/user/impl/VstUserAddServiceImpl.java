...
import com.vst.defend.dao2.user.VstUserAddDao;
 ...
 * 
 * @author lhp
 * @date 2017-12-29 下午02:54:53
 * @version
 */
@Service
public class VstUserAddServiceImpl implements VstUserAddService {
	/**
	 * 写日志
	 */
	private static final Log logger = LogFactory.getLog(VstUserAddServiceImpl.class);
	
	/**
	 * 新增用户Dao接口
	 */
	@Resource
	private VstUserAddDao _vstUserAddDao;
	...
	public ReportBean getExportData(Map<String, Object> params, UserSession user) throws SystemException {
		...
		try{
			...
			List<Map<String, Object>> data = _vstUserAddDao.queryExport(params);
			...
			bean.setTitle("vst_user_add_data");
			...
			logger.error("导出新增用户数据失败: " + SystemException.getExceptionInfo(e));
