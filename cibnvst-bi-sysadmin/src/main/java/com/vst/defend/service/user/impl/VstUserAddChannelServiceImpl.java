 ...
 * 
 * @author lhp
 * @date 2018-1-3 下午04:00:33
 * @version
 */
@Service
public class VstUserAddChannelServiceImpl implements VstUserAddChannelService {
	/**
	 * 写日志
	 */
	private static final Log logger = LogFactory.getLog(VstUserAddChannelServiceImpl.class);
	...
	public ReportBean getExportData(Map<String, Object> params, UserSession user) throws SystemException {
		...
		try{
			...
			List<Map<String, Object>> data = _vstUserAddChannelDao.queryExport(params);
			...
			logger.error("导出新增用户(渠道)数据失败: " + SystemException.getExceptionInfo(e));
	...
	public JSONObject getReportByChannel(Map<String, Object> params) throws SystemException {
		...
		try {
			...
			List<Map<String, Object>> list = _vstUserAddChannelDao.queryReportByChannel(params);
