...
import com.vst.defend.dao2.user.VstUserActiveUpVerDao;
 ...
 * 
 * @author lhp
 * @date 2018-1-4 下午07:49:58
 * @version
 */
@Service
public class VstUserActiveUpVerServiceImpl implements VstUserActiveUpVerService {
	/**
	 * 写日志
	 */
	 ...
	 */
	@Resource
	private VstUserActiveUpVerDao _vstUserActiveUpVerDao;
	...
	public ReportBean getExportData(Map<String, Object> params, UserSession user) throws SystemException {
		...
		try{
			...
			List<Map<String, Object>> data = _vstUserActiveUpVerDao.queryExport(params);
			...
			bean.setTitle("vst_user_active_upVer_data");
			...
			logger.error("导出活跃用户(升级版本)数据失败: " + SystemException.getExceptionInfo(e));
