 ...
 * 
 * @author lhp
 * @date 2018-1-23 下午04:49:08
 * @version
 */
@Service
public class VstMovieTotalPlayServiceImpl implements VstMovieTotalPlayService {
	/**
	 * 写日志
	 */
	private static final Log logger = LogFactory.getLog(VstMovieTotalPlayServiceImpl.class);
	...
	public ReportBean getExportData(Map<String, Object> params, UserSession user) throws SystemException {
		...
		try{
			...
			List<Map<String, Object>> data = _vstMovieTotalPlayDao.queryExport(params);
			...
			bean.setTitle("vst_movie_total_play_data");
			...
			logger.error("导出汇总播放数据失败: " + SystemException.getExceptionInfo(e));
