...
import com.vst.defend.dao2.user.VstUserStartupDao;
 ...
 * 
 * @author lhp
 * @date 2018-2-5 上午10:22:39
 * @version
 */
@Service
public class VstUserStartupServiceImpl implements VstUserStartupService {
	/**
	 * 写日志
	 */
	private static final Log logger = LogFactory.getLog(VstUserStartupServiceImpl.class);
	
	/**
	 * 启动次数Dao接口
	 */
	@Resource
	private VstUserStartupDao _vstUserStartupDao;
	...
	public ReportBean getExportData(Map<String, Object> params, UserSession user) throws SystemException {
		...
		try{
			...
			List<Map<String, Object>> data = _vstUserStartupDao.queryExport(params);
			...
			bean.setTitle("vst_user_startup_data");
			...
			logger.error("导出启动次数数据失败: " + SystemException.getExceptionInfo(e));
