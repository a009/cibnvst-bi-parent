...
import com.vst.defend.dao2.user.VstUserSecondaryActiveDao;
 ...
 */
@Service
public class VstUserSecondaryActiveServiceImpl implements VstUserSecondaryActiveService {
    /**
     * 写日志
     */
    private static final Log logger = LogFactory.getLog(VstUserSecondaryActiveServiceImpl.class);

    /**
     * 二次活跃用户Dao接口
     */
    @Resource
    private VstUserSecondaryActiveDao _vstUserSecondaryActiveDao;
    ...
    public ReportBean getExportData(Map<String, Object> params, UserSession user) throws SystemException {
        ...
        try{
            ...
            List<Map<String, Object>> data = _vstUserSecondaryActiveDao.queryExport(params);
            ...
            bean.setTitle("vst_user_secondary_active_data");
            ...
            logger.error("导出二次活跃用户数据失败: " + SystemException.getExceptionInfo(e));
