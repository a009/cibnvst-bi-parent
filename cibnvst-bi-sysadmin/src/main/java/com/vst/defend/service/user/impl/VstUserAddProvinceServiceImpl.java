...
import com.vst.defend.dao2.user.VstUserAddProvinceDao;
 ...
 * 
 * @author lhp
 * @date 2018-1-3 下午05:04:56
 * @version
 */
@Service
public class VstUserAddProvinceServiceImpl implements VstUserAddProvinceService {
	/**
	 * 写日志
	 */
	 ...
	 */
	@Resource
	private VstUserAddProvinceDao _vstUserAddProviceDao;
	...
	public ReportBean getExportData(Map<String, Object> params, UserSession user) throws SystemException {
		...
		try{
			...
			List<Map<String, Object>> data = _vstUserAddProviceDao.queryExport(params);
			...
			bean.setTitle("vst_user_add_province_data");
			...
			logger.error("导出新增用户(省份)数据失败: " + SystemException.getExceptionInfo(e));
