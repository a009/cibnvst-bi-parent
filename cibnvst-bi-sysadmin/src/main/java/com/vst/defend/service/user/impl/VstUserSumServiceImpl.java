...
import com.vst.defend.dao2.user.VstUserSumDao;
 ...
 * 
 * @author lhp
 * @date 2018-1-3 上午10:01:09
 * @version
 */
@Service
public class VstUserSumServiceImpl implements VstUserSumService {
	/**
	 * 写日志
	 */
	private static final Log logger = LogFactory.getLog(VstUserSumServiceImpl.class);
	
	/**
	 * 累计用户Dao接口
	 */
	@Resource
	private VstUserSumDao _vstUserSumDao;
	...
	public ReportBean getExportData(Map<String, Object> params, UserSession user) throws SystemException {
		...
		try{
			...
			List<Map<String, Object>> data = _vstUserSumDao.queryExport(params);
			...
			bean.setTitle("vst_user_sum_data");
			...
			logger.error("导出累计用户数据失败: " + SystemException.getExceptionInfo(e));
