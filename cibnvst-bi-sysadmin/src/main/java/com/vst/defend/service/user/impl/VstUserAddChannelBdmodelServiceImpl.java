...
import com.vst.defend.dao2.user.VstUserAddChannelBdmodelDao;
 ...
 * 
 * @author lhp
 * @date 2019-3-6 下午12:30:16
 * @version
 */
@Service
public class VstUserAddChannelBdmodelServiceImpl implements VstUserAddChannelBdmodelService {
	/**
	 * 写日志
	 */
	private static final Log logger = LogFactory.getLog(VstUserAddChannelBdmodelServiceImpl.class);
	
	/**
	 * 新增用户(渠道、设备)Dao接口
	 */
	@Resource
	private VstUserAddChannelBdmodelDao _vstUserAddChannelBdmodelDao;
	...
	public ReportBean getExportData(Map<String, Object> params, UserSession user) throws SystemException {
		...
		try{
			...
			List<Map<String, Object>> data = _vstUserAddChannelBdmodelDao.queryExport(params);
			...
			bean.setTitle("vst_user_add_channel_bdmodel_data");
			...
			logger.error("导出新增用户(渠道、设备)数据失败: " + SystemException.getExceptionInfo(e));
	...
	public JSONObject getReportByBdmodel(Map<String, Object> params) throws SystemException {
		...
		try {
			...
			List<Map<String, Object>> list = _vstUserAddChannelBdmodelDao.queryReportByBdmodel(params);
