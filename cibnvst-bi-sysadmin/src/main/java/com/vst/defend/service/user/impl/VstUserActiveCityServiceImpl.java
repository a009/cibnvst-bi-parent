...
import com.vst.defend.dao2.user.VstUserActiveCityDao;
 ...
 * 
 * @author lhp
 * @date 2018-1-4 下午07:47:22
 * @version
 */
@Service
public class VstUserActiveCityServiceImpl implements VstUserActiveCityService {
	/**
	 * 写日志
	 */
	 ...
	 */
	@Resource
	private VstUserActiveCityDao _vstUserActiveCityDao;
	...
	public ReportBean getExportData(Map<String, Object> params, UserSession user) throws SystemException {
		...
		try{
			...
			List<Map<String, Object>> data = _vstUserActiveCityDao.queryExport(params);
			...
			bean.setTitle("vst_user_active_city_data");
			...
			logger.error("导出活跃用户(城市)数据失败: " + SystemException.getExceptionInfo(e));
	...
	public ReportBean getReportByCity(Map<String, Object> params) throws SystemException {
		...
		try {
			...
			List<Map<String, Object>> list = _vstUserActiveCityDao.queryReportByDim(params);
