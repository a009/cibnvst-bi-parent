...
import com.vst.defend.dao2.user.VstUserAddBdmodelDao;
 ...
 * 
 * @author lhp
 * @date 2019-3-6 上午10:56:16
 * @version
 */
@Service
public class VstUserAddBdmodelServiceImpl implements VstUserAddBdmodelService {
	/**
	 * 写日志
	 */
	private static final Log logger = LogFactory.getLog(VstUserAddBdmodelServiceImpl.class);
	
	/**
	 * 新增用户(设备)Dao接口
	 */
	@Resource
	private VstUserAddBdmodelDao _vstUserAddBdmodelDao;
	...
	public ReportBean getExportData(Map<String, Object> params, UserSession user) throws SystemException {
		...
		try{
			...
			List<Map<String, Object>> data = _vstUserAddBdmodelDao.queryExport(params);
			...
			bean.setTitle("vst_user_add_bdmodel_data");
			...
			logger.error("导出新增用户(设备)数据失败: " + SystemException.getExceptionInfo(e));
