...
import com.vst.defend.dao2.user.VstUserAddVersionBdmodelDao;
 ...
 * 
 * @author lhp
 * @date 2019-3-12 下午03:41:22
 * @version
 */
@Service
public class VstUserAddVersionBdmodelServiceImpl implements VstUserAddVersionBdmodelService {
	/**
	 * 写日志
	 */
	private static final Log logger = LogFactory.getLog(VstUserAddVersionBdmodelServiceImpl.class);
	
	/**
	 * 新增用户(版本、设备)Dao接口
	 */
	@Resource
	private VstUserAddVersionBdmodelDao _vstUserAddVersionBdmodelDao;
	...
	public ReportBean getExportData(Map<String, Object> params, UserSession user) throws SystemException {
		...
		try{
			...
			List<Map<String, Object>> data = _vstUserAddVersionBdmodelDao.queryExport(params);
			...
			bean.setTitle("vst_user_add_version_bdmodel_data");
			...
			logger.error("导出新增用户(版本、设备)数据失败: " + SystemException.getExceptionInfo(e));
	...
	public JSONObject getReportByBdmodel(Map<String, Object> params) throws SystemException {
		...
		try {
			...
			List<Map<String, Object>> list = _vstUserAddVersionBdmodelDao.queryReportByBdmodel(params);
