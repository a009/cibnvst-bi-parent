...
import com.vst.defend.dao2.user.VstUserActiveVersionUpVerDao;
 ...
 * 
 * @author lhp
 * @date 2018-1-4 下午07:52:18
 * @version
 */
@Service
public class VstUserActiveVersionUpVerServiceImpl implements VstUserActiveVersionUpVerService {
	/**
	 * 写日志
	 */
	private static final Log logger = LogFactory.getLog(VstUserActiveVersionServiceImpl.class);
	
	/**
	 * 活跃用户(显示版本、升级版本)Dao接口
	 */
	@Resource
	private VstUserActiveVersionUpVerDao _vstUserActiveVersionUpVerDao;
	...
	public ReportBean getExportData(Map<String, Object> params, UserSession user) throws SystemException {
		...
		try{
			...
			List<Map<String, Object>> data = _vstUserActiveVersionUpVerDao.queryExport(params);
			...
			bean.setTitle("vst_user_active_version_upVer_data");
			...
			logger.error("导出活跃用户(显示版本、升级版本)数据失败: " + SystemException.getExceptionInfo(e));
	...
	public JSONObject getReportByUpVer(Map<String, Object> params) throws SystemException {
		...
		try {
			...
			List<Map<String, Object>> list = _vstUserActiveVersionUpVerDao.queryReportByUpVer(params);
