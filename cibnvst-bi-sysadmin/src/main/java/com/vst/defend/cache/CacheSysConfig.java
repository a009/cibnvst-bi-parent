...
public class CacheSysConfig {
	 ...
	 * 缓存集合数据
	 */
	private Map<String, List<Map<String, Object>>> _dataMap = new HashMap<String, List<Map<String,Object>>>();
	 ...
	 * @param value
	 */
	public void putDataMap(String key, List<Map<String, Object>> value){
	 ...
	 * @return
	 */
	public List<Map<String, Object>> getDataMap(String key, Map<String, Object> params){
		List<Map<String, Object>> result = new ArrayList<Map<String,Object>>();
		try{
			if(params == null){
				result = _dataMap.get(key);
			}else{
				if(_dataMap.get(key) != null){
					for(Map<String, Object> map : _dataMap.get(key)){
						boolean isAdd = true;
						for(String k : params.keySet()){
							if(map.containsKey(k)){
								if(!(map.get(k)+"").equals(params.get(k)+"")){
									isAdd = false;
								}
							}
						}
