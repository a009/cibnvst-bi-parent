	...
	<div class="wrapper">
		...
		<div class="content-wrapper">
			<div class="content-roll">
				<form id="listForm" action="${ctx}/featuresConfig/addFeaturesConfig.action" method="post" enctype="multipart/form-data">
					<%@include file="../share/sharForm.jsp"%>
					<section class="content-header">
						<i class="fa fa-home"></i>
						<a href="${ctx}/sysMain/index.action">首页</a>
						<span> > 配置管理 > 用户指标特征配置新增</span>
					</section>
						...
						<div id="move">
							<ul id='example2' class="line03">
								...
								<li>
									...
									<div class="add_m">
										<div class="add_m_l">
											<input type="text" class="input" id="vst_features_name" name="vst_features_name" placeholder="请输入特征名称，-2:全部,-1:其它" />
										</div>
										<div class="add_m_r">
											<span class="red">*</span>
										</div>
								...
								<li>
									...
									<div class="add_m">
										<div class="add_m_l">
											<input type="text" class="input" id="vst_features_value" name="vst_features_value" value="0.0000" placeholder="请输入特征名称" />
										</div>
										<div class="add_m_r">
											<span class="red">*</span>
										</div>
								...
								<li>
									...
									<div class="add_m">
										<div class="add_m_l">
											<input type="text" class="input" id="vst_features_index" name="vst_features_index" value="0" placeholder="请输入排序,排序越大越靠前" />
										</div>
										<div class="add_m_r">
											<span class="red">*</span>
										</div>
