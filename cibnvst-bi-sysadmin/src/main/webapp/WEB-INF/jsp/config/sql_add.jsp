	...
	<div class="wrapper">
		...
		<div class="content-wrapper">
			<div class="content-roll">
				<form id="listForm" action="${ctx}/sql/addSql.action" method="post" enctype="multipart/form-data">
					<%@include file="../share/sharForm.jsp"%>
					<section class="content-header">
						<i class="fa fa-home"></i>
						<a href="${ctx}/sysMain/index.action">首页</a>
						<span> > 配置管理 > spark任务新增</span>
					</section>
						...
						<div id="move">
							<ul id='example2' class="line03">
								...
								<li>
									...
									<div class="add_m">
										<div class="add_m_l">
											<input type="text" class="input" id="vst_sql_name" name="vst_sql_name" placeholder="请输入任务名称" />
										</div>
										<div class="add_m_r">
											<span class="red">*</span>
										</div>
								...
								<li>
									...
									<div class="add_m">
										<div class="add_m_l">
											<textarea class="input" id="vst_sql_topic" name="vst_sql_topic" style="height: 100px;" placeholder="请输入topic"></textarea>
										</div>
										<div class="add_m_r">
								...
								<li>
									...
									<div class="add_m">
										<div class="add_m_l">
											<input type="text" class="input" id="vst_sql_interval" name="vst_sql_interval" value="0" placeholder="请输入任务间隔" />
										</div>
										<div class="add_m_r">
											<span class="red">*</span>
										</div>
								...
								<li>
									...
									<div class="add_m">
										<div class="add_m_l">
											<textarea class="input" id="vst_sql_data_path" name="vst_sql_data_path" style="resize: none; height: 100px;" placeholder="请输入sql数据来源"></textarea>
										</div>
										<div class="add_m_r">
								...
								<li>
									...
									<div class="add_m">
										<div class="add_m_l">
											<input type="text" class="input" id="vst_sql_temp_table" name="vst_sql_temp_table" placeholder="请输入spark临时表名" />
										</div>
										<div class="add_m_r">
								...
								<li>
									...
									<div class="add_m">
										<div class="add_m_l">
											<input type="text" class="input" id="vst_sql_table" name="vst_sql_table" placeholder="请输入计算结果表名" />
										</div>
										<div class="add_m_r">
									...
									<div class="add_m">
										<div class="add_m_l">
											<textarea class="input" id="vst_sql_rowkeyColumn" name="vst_sql_rowkeyColumn" style="resize: none; height: 100px;" 
												placeholder="只有当保存数据源是hbase的时候才有意义，如果有多个，用英文逗号隔开"></textarea>
										</div>
										<div class="add_m_r">
								...
								<li>
									...
									<div class="add_m">
										<div class="add_m_l">
											<input type="text" class="input" id="vst_sql_runtime" name="vst_sql_runtime" placeholder="yyyy-MM-dd HH:mm:ss" maxlength="19"/>
										</div>
										<div class="add_m_r">
									...
									<div class="add_m">
										<div class="add_m_l">
											<textarea class="input" id="vst_sql_run_position" name="vst_sql_run_position"
												style="resize: none; height: 100px;" placeholder="格式：yyyyMMdd|HH|mm"></textarea>
										</div>
										<div class="add_m_r">
									...
									<div class="add_m">
										<div class="add_m_l">
											<textarea class="input" id="vst_sql_joinKeys" name="vst_sql_joinKeys"
												style="resize: none; height: 100px;" placeholder="若有多个，用“|”隔开"></textarea>
										</div>
										<div class="add_m_r">
								...
								<li>
									...
									<div class="add_m">
										<div class="add_m_l">
											<input type="text" class="input" id="vst_sql_priority" name="vst_sql_priority" value="-1" placeholder="请输入优先级，数值越大优先级越高" />
										</div>
										<div class="add_m_r">
											<span class="red">*</span>
										</div>
								...
								<li>
									...
									<div class="add_m">
										<div class="add_m_l">
											<input type="text" class="input" id="vst_sql_index" name="vst_sql_index" value="0" placeholder="请输入排序,排序越大越靠前" />
										</div>
										<div class="add_m_r">
											<span class="red">*</span>
										</div>
								...
								<li>
									...
									<div class="add_m">
										<div class="add_m_l">
											<textarea class="input" id="vst_sql_summary" name="vst_sql_summary" style="resize: none; height: 100px;" placeholder="请输入备注"></textarea>
										</div>
										<div class="add_m_r">
