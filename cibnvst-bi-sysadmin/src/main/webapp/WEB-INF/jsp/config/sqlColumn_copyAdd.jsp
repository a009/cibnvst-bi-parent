	...
	<div class="wrapper">
		...
		<div class="content-wrapper">
			<div class="content-roll">
				<form id="listForm" action="${ctx}/sqlColumn/copyAddSqlColumn.action" method="post" enctype="multipart/form-data">
					<%@include file="../share/sharForm.jsp"%>
					<section class="content-header">
						<i class="fa fa-home"></i>
						<a href="${ctx}/sysMain/index.action">首页</a>
						<span> > 配置管理 > sql列配置复制新增</span>
					</section>
						...
						<div id="move">
							<ul id='example2' class="line03">
									...
									<div class="add_m">
										<div class="add_m_l">
											<textarea class="input" id="vst_column_name" name="vst_column_name" 
												style="resize: none; height: 100px;" placeholder="请输入列字段名称">${formMap.vst_column_name }</textarea>
										</div>
										<div class="add_m_r">
											<span class="red">*</span>
										</div>
								...
								<li>
									...
									<div class="add_m">
										<div class="add_m_l">
											<input type="text" class="input" id="vst_column_alias" name="vst_column_alias" value="${formMap.vst_column_alias }" placeholder="请输入列字段别名" />
										</div>
										<div class="add_m_r">
								...
								<li>
									...
									<div class="add_m">
										<div class="add_m_l">
											<input type="hidden" id="hidden_column_operateType" value="${formMap.vst_column_operateType }" />
								...
								<li>
									...
									<div class="add_m">
										<div class="add_m_l">
											<input type="hidden" id="hidden_column_dataType" value="${formMap.vst_column_dataType }" />
								...
								<li>
									...
									<div class="add_m">
										<div class="add_m_l">
											<input type="text" class="input" id="vst_column_index" name="vst_column_index" value="${formMap.vst_column_index }" placeholder="请输入排序,排序越大越靠前" />
										</div>
										<div class="add_m_r">
											<span class="red">*</span>
										</div>
								...
								<li>
									...
									<div class="add_m">
										<div class="add_m_l">
											<input type="radio" value="1" name="vst_column_state" />正常&nbsp;&nbsp;
											<input type="radio" value="2" name="vst_column_state" checked="checked" />禁用
										</div>
										<div class="add_m_r">
									...
									<div class="add_r">
										<span id="vst_column_stateTip"></span>
									</div>
								</li>
								<li>
									...
									<div class="add_m">
										<div class="add_m_l">
											<textarea class="input" id="vst_column_summary" name="vst_column_summary" 
												style="resize: none; height: 100px;" placeholder="请输入备注">${formMap.vst_column_summary }</textarea>
										</div>
										<div class="add_m_r">
