	...
	<div class="wrapper">
		...
		<div class="content-wrapper">
			<div class="content-roll">
				<form id="listForm" action="${ctx}/sqlSave/addSqlSave.action" method="post" enctype="multipart/form-data">
					<%@include file="../share/sharForm.jsp"%>
					<section class="content-header">
						<i class="fa fa-home"></i>
						<a href="${ctx}/sysMain/index.action">首页</a>
						<span> > 配置管理 > sql数据保存配置新增</span>
					</section>
						...
						<div id="move">
							<ul id='example2' class="line03">
								<li>
									...
									<div class="add_m">
										<div class="add_m_l">
											<input type="text" class="input" id="vst_save_table" name="vst_save_table" placeholder="请输入插入表名称" />
										</div>
										<div class="add_m_r">
								...
								<li>
									...
									<div class="add_m">
										<div class="add_m_l">
											<input type="text" class="input" id="vst_save_name" name="vst_save_name" placeholder="请输入列字段名称" />
										</div>
										<div class="add_m_r">
								...
								<li>
									...
									<div class="add_m">
										<div class="add_m_l">
											<input type="text" class="input" id="vst_save_default" name="vst_save_default" placeholder="该字段为空的时候默认值" />
										</div>
										<div class="add_m_r">
								...
								<li>
									...
									<div class="add_m">
										<div class="add_m_l">
											<input type="text" class="input" id="vst_save_length" name="vst_save_length" value="0" placeholder="字段长度范围" />
										</div>
										<div class="add_m_r">
											<span class="red">*</span>
										</div>
									...
									<div class="add_m">
										<div class="add_m_l">
											<textarea class="input" id="vst_save_format_union" name="vst_save_format_union" 
												style="resize: none; height: 100px;" placeholder="格式化所需要关联的字段，如果用多个，用英文逗号隔开，通常用于格式化类型5和6"></textarea>
										</div>
										<div class="add_m_r">
								...
								<li>
									...
									<div class="add_m">
										<div class="add_m_l">
											<input type="text" class="input" id="vst_save_index" name="vst_save_index" value="0" placeholder="请输入排序,排序越大越靠前" />
										</div>
										<div class="add_m_r">
											<span class="red">*</span>
										</div>
