	...
	<div class="wrapper">
		...
		<div class="content-wrapper">
			<div class="content-roll">
				<form id="listForm" action="${ctx}/sqlGroup/editSqlGroup.action" method="post" enctype="multipart/form-data">
					<input type="hidden" name="vst_group_id" value="${formMap.vst_group_id }" />
					<%@include file="../share/sharForm.jsp"%>
					<section class="content-header">
						<i class="fa fa-home"></i>
						<a href="${ctx}/sysMain/index.action">首页</a>
						<span> > 配置管理 > sql分组配置修改</span>
					</section>
