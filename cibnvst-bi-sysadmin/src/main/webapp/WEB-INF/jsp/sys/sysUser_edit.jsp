	...
	<div class="wrapper">
		...
		<div class="content-wrapper">
			<div class="content-roll">
				<form id="listForm" action="${ctx}/sysUser/editUser.action" method="post" enctype="multipart/form-data">
					<input type="hidden" name="vst_sys_id" value="${formMap.vst_sys_id }" />
					<%@include file="../share/sharForm.jsp"%>
					<section class="content-header">
						<i class="fa fa-home"></i>
						<a href="${ctx}/sysMain/index.action">首页</a>
						<span> > 系统管理 > 系统用户修改</span>
					</section>
						...
						<div id="move">
							<ul id='example2' class="line03">
								...
								<li>
									...
									<div class="add_m">
										<div class="add_m_l">
											<input type="text" class="input" id="vst_sys_name" name="vst_sys_name" value="${formMap.vst_sys_name }" placeholder="请输入用户名称" />
										</div>
										<div class="add_m_r">
											<span class="red">*</span>
										</div>
									...
									<div class="add_m">
										<div class="add_m_l">
											<textarea class="input" id="vst_sys_photo" name="vst_sys_photo"
												style="resize: none; height: 100px;" placeholder="请输入头像">${formMap.vst_sys_photo }</textarea>
										</div>
										<div class="add_m_r">
								...
								<li>
									...
									<div class="add_m">
										<div class="add_m_l">
											<input type="hidden" id="vst_role_id" name="vst_role_id" value="${formMap.vst_role_id }" />
							        		<input class="input" type="text" id="roleNames" readonly="readonly" value="${formMap.vst_role_name }" placeholder="请选择角色" />
										</div>
										<div class="add_m_r">
											<span class="red">*</span>
								...
								<li>
									...
									<div class="add_m">
										<div class="add_m_l">
											<input type="hidden" id="hidden_sys_division" value="${formMap.vst_sys_division }" />
								...
								<li>
									...
									<div class="add_m">
										<div class="add_m_l">
											<input type="hidden" id="hidden_sys_job" value="${formMap.vst_sys_job }" />
								...
								<li>
									...
									<div class="add_m">
										<div class="add_m_l">
											<input type="text" class="input" id="vst_sys_channel" name="vst_sys_channel" value="${formMap.vst_sys_channel }" placeholder="all代表全部，多个用逗号分割" />
										</div>
										<div class="add_m_r">
											<span class="red">*</span>
										</div>
									...
									<div class="add_m">
										<div class="add_m_l">
											<textarea class="input" id="vst_sys_summary" name="vst_sys_summary"
												style="resize: none; height: 100px;" placeholder="请输入备注">${formMap.vst_sys_summary }</textarea>
										</div>
										<div class="add_m_r">
