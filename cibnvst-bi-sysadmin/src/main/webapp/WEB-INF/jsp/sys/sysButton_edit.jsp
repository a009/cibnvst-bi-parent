	...
	<div class="wrapper">
		...
		<div class="content-wrapper">
			<div class="content-roll">
				<form id="listForm" action="${ctx}/sysButton/editButton.action" method="post">
					<input type="hidden" name="vst_button_id" value="${formMap.vst_button_id }" />
					<%@include file="../share/sharForm.jsp"%>
					<section class="content-header">
						<i class="fa fa-home"></i>
						<a href="${ctx}/sysMain/index.action">首页</a>
						<span> > 系统管理 > 系统按钮修改</span>
					</section>
						...
						<div id="move">
							<ul id='example2' class="line03">
								<li>
									...
									<div class="add_m">
										<div class="add_m_l">
											<input type="text" class="input" id="vst_button_name" name="vst_button_name" value="${formMap.vst_button_name }" placeholder="请输入按钮名称" />
										</div>
										<div class="add_m_r">
											<span class="red">*</span>
										</div>
								...
								<li>
									...
									<div class="add_m">
										<div class="add_m_l">
											<input type="text" class="input" id="vst_button_img" name="vst_button_img" value="${formMap.vst_button_img }" placeholder="请输入按钮图片" />
										</div>
										<div class="add_m_r">
											<span class="red">*</span>
										</div>
								...
								<li>
									...
									<div class="add_m">
										<div class="add_m_l">
											<input type="text" class="input" id="vst_button_onclick" name="vst_button_onclick" value="${formMap.vst_button_onclick }" placeholder="请输入按钮事件" />
										</div>
										<div class="add_m_r">
											<span class="red">*</span>
										</div>
								...
								<li>
									...
									<div class="add_m">
										<div class="add_m_l">
											<input type="text" class="input" id="vst_button_index" name="vst_button_index" value="${formMap.vst_button_index }" placeholder="请输入排序" />
										</div>
										<div class="add_m_r">
											<span class="red">*</span>
										</div>
									...
									<div class="add_m">
										<div class="add_m_l">
											<textarea class="input" id="vst_button_summary" name="vst_button_summary" placeholder="请输入备注"
												style="resize: none; height: 100px;">${formMap.vst_button_summary }</textarea>
										</div>
										<div class="add_m_r">
