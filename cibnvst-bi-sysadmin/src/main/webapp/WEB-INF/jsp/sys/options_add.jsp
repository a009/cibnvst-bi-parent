...
<script type="text/javascript">
	...
	function checkOptionKey(){
		var result = true;
		var opKey = $.trim($("#vst_option_key").val());
		if(opKey == ""){
			result = false;
		}else{
			$.ajax({  
				url:'${ctx}/options/ajaxCheckKey.action?opKey='+opKey, //需要链接到服务器地址
				type:"POST",
				cache:false,
				async:false,
				dataType: 'json',
	...
	<div class="wrapper">
		...
		<div class="content-wrapper">
			<div class="content-roll">
				<form id="listForm" action="${ctx}/options/addOptions.action" method="post" enctype="multipart/form-data">
					<%@include file="../share/sharForm.jsp"%>
					<section class="content-header">
						<i class="fa fa-home"></i>
						<a href="${ctx}/sysMain/index.action">首页</a>
						<span> > 系统管理 > 控制面板新增</span>
					</section>
						...
						<div id="move">
							<ul id='example2' class="line03">
								<li>
									...
									<div class="add_m">
										<div class="add_m_l">
											<input type="text" class="input" id="vst_option_key" name="vst_option_key" placeholder="请输入配置关键字" />
										</div>
										<div class="add_m_r">
											<span class="red">*</span>
										</div>
									...
									<div class="add_m">
										<div class="add_m_l">
											<textarea class="input" id="vst_option_value" name="vst_option_value"
												style="resize: none; height: 100px;" placeholder="请输入配置内容"></textarea>
										</div>
										<div class="add_m_r">
								...
								<li>
									...
									<div class="add_m">
										<div class="add_m_l">
											<textarea class="input" id="vst_option_desc" name="vst_option_desc"
