	...
	<div class="wrapper">
		...
		<div class="content-wrapper" style="background-color: #ecf0f5;">
					...
					<div class="modal-content">
						<div class="modal-header">
							...
							<h4 class="modal-title">
								<i class="fa fa-home"></i><span style="font-size:14px;">产品统计 > 季质量用户(渠道)统计 > 导出</span>
							</h4>
						</div>
			...
			<div class="content-roll">
				<form action="${ctx}/userLevelChannel/findUserLevelChannel.action" id="listForm" method="post">
					<%@include file="../share/sharForm.jsp"%>
					<section class="content-header">
						<i class="fa fa-home"></i>
						<a href="${ctx}/sysMain/index.action">首页</a>
						<span> > 产品统计 > 季质量用户(渠道)统计
...
<script type="text/javascript">
	...
	function line(msg){
		...
		$.each(data,function(i,n){
			...
			vst_ulc_season_dod[i] = Math.round(n.vst_ulc_season_dod*100)/100;
			vst_ulc_season_wow[i] = Math.round(n.vst_ulc_season_wow*100)/100;
			vst_ulc_season_radio[i] = Math.round(n.vst_ulc_season_radio*100)/100;
		});
	...
	function showTable(msg){
		...
		$.each(data,function(i,n){
			var row = i%2+1;
			var ulSeasonDodColor = "green";
			var ulSeasonWowColor = "green";
			
			if(parseFloat(n.vst_ulc_season_dod)<0){
				ulSeasonDodColor = "red";
			}
			if(parseFloat(n.vst_ulc_season_wow)<0){
				ulSeasonWowColor = "red";
			}
			...
			table += "<span class='"+ulSeasonDodColor+"'>"+toString(n.vst_ulc_season_dod)+"</span> | ";
			table += "<span class='"+ulSeasonWowColor+"'>"+toString(n.vst_ulc_season_wow)+"</span></td>";
			//占比
		...
		$("#exportSubmit").click(function(){
			...
			if(flag){
				...
				if(confirm("导出速度，由数据大小决定，请耐心等待。。")){
					...
					location.href = "${ctx}/userLevelChannel/exportData.action?" + params
