	...
	<div class="wrapper">
		...
		<div class="content-wrapper" style="background-color: #ecf0f5;">
					...
					<div class="modal-content">
						<div class="modal-header">
							...
							<h4 class="modal-title">
								<i class="fa fa-home"></i><span style="font-size:14px;">产品统计 > 二次活跃用户(渠道)统计 > 导出</span>
							</h4>
						</div>
			...
			<div class="content-roll">
				<form action="${ctx}/userSecondaryActiveChannel/findUserSecondaryActiveChannel.action" id="listForm" method="post">
					<%@include file="../share/sharForm.jsp"%>
					<section class="content-header">
						<i class="fa fa-home"></i>
						<a href="${ctx}/sysMain/index.action">首页</a>
						<span> > 产品统计 > 二次活跃用户(渠道)统计
...
<script type="text/javascript">
	...
	function ajaxGetReport(){
		...
		var ajaxUrl;
		if($("#vst_usac_channel").val() == ''){
			ajaxUrl = "${ctx}/userSecondaryActiveChannel/ajaxGetReportByChannel.action";
		}else{
			ajaxUrl = "${ctx}/report/json?code=user_secondary_active_channel_line";
		}
	...
	function showTable(msg){
		...
		$.each(data,function(i,n){
			var row = i%2+1;
			var usacDodColor = "green";
			var usacWowColor = "green";
			var usacMomColor = "green";
			...
			table += "<td class='"+usacDodColor+"'>"+toString(n.vst_usac_dod)+"</td>";
			table += "<td class='"+usacWowColor+"'>"+toString(n.vst_usac_wow)+"</td>";
			table += "<td class='"+usacMomColor+"'>"+toString(n.vst_usac_mom)+"</td>";
		...
		$("#exportSubmit").click(function(){
			...
			if(flag){
				...
				if(confirm("导出速度，由数据大小决定，请耐心等待。。")){
					...
					location.href = "${ctx}/userSecondaryActiveChannel/exportData.action?" + params
