	...
	<div class="wrapper">
		...
		<div class="content-wrapper" style="background-color: #ecf0f5;">
					...
					<div class="modal-content">
						<div class="modal-header">
							...
							<h4 class="modal-title">
								<i class="fa fa-home"></i><span style="font-size:14px;">产品统计 > 新增用户(城市)统计 > 导出</span>
							</h4>
						</div>
			...
			<div class="content-roll">
				<form action="${ctx}/userAddCity/findUserAddCity.action" id="listForm" method="post">
					<%@include file="../share/sharForm.jsp"%>
					<section class="content-header">
						<i class="fa fa-home"></i>
						<a href="${ctx}/sysMain/index.action">首页</a>
						<span> > 产品统计 > 新增用户(城市)统计
...
<script type="text/javascript">
	...
	function ajaxGetReport(){
		...
		$.ajax({
			...
			async : true,
			cache : false,
			url:"${ctx}/report/json?code=user_add_city_line",
			dataType:"json",
	...
	function ajaxGetReportByCity(){
		...
		$.ajax({
			...
			async : true,
			cache : false,
			url:"${ctx}/userAddCity/ajaxGetReportByCity.action",
			dataType:"json",
			success:function(msg){
...
//                center: [121.472644, 31.231706],
	...
	function ajaxGetReportByDim(){
		...
		$.ajax({
			...
			async : true,
			cache : false,
			url:"${ctx}/report/json?code=user_add_city_dim",
			dataType:"json",
			success:function(msg){
	...
	function ajaxGetCutPage(){
		...
		$.ajax({
			...
			async : true,
			cache : false,
			url:"${ctx}/report/json?code=user_add_city_table",
			dataType:"json",
			success:function(msg){
	...
	function showTable(msg){
		...
		table += "<th width='15%'><a onclick='changeOrder(this)' orderBy='vst_uaci_city' id='vst_uaci_city2' order='desc' style='color:orange;'>城市</a></th>";
		table += "<th width='15%'><a onclick='changeOrder(this)' orderBy='vst_uaci_amount' id='vst_uaci_amount2' order='desc'>新增用户</a></th>";
		table += "<th width='15%'><a onclick='changeOrder(this)' orderBy='vst_uaci_dod' id='vst_uaci_dod2' order='desc'>天环比</a></th>";
		table += "<th width='15%'><a onclick='changeOrder(this)' orderBy='vst_uaci_wow' id='vst_uaci_wow2' order='desc'>周环比</a></th>";
		table += "<th width='15%'><a onclick='changeOrder(this)' orderBy='vst_uaci_mom' id='vst_uaci_mom2' order='desc'>月环比</a></th>";
		...
		$.each(data,function(i,n){
			...
			table += "<td>"+formatNumber(n.vst_uaci_amount)+"</td>";
			table += "<td class='"+uaDodColor+"'>"+toString(n.vst_uaci_dod)+"</td>";
			table += "<td class='"+uaWowColor+"'>"+toString(n.vst_uaci_wow)+"</td>";
			table += "<td class='"+uaMomColor+"'>"+toString(n.vst_uaci_mom)+"</td>";
		...
		$("#exportSubmit").click(function(){
			...
			if(flag){
				...
				if(confirm("导出速度，由数据大小决定，请耐心等待。。")){
					...
					location.href = "${ctx}/userAddCity/exportData.action?" + params
