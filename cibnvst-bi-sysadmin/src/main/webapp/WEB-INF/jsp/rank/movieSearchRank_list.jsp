	...
	<div class="wrapper">
		...
		<div class="content-wrapper" style="background-color: #ecf0f5;">
			...
			<div class="content-roll">
				<form action="${ctx}/movieSearchRank/findMovieSearchRank.action" id="listForm" method="post">
					<%@include file="../share/sharForm.jsp"%>
					<section class="content-header">
						<i class="fa fa-home"></i>
						<a href="${ctx}/sysMain/index.action">首页</a>
						<span> > 排行统计 > 影片搜索统计</span>
					</section>
...
<script type="text/javascript">
	...
	function ajaxGetCutPage(){
		...
		$.ajax({
			...
			async : true,
			cache : false,
			url:"${ctx}/movieSearchRank/ajaxGetCutPage.action",
			dataType:"json",
	...
	function showTable(msg){
		...
		$.each(data,function(i,n){
			...
			table += "<td>"+toString(n.vst_mos_uuid)+"</td>";
			table += "<td title='"+n.vst_mos_name+"'>"+toString(n.vst_mos_name)+"</td>";
			table += "<td>"+formatNumber(n.vst_mos_amount)+"</td>";
	...
	function button_export(){
		...
		if(!isNotEmpty(startDay) || !isNotEmpty(endDay) || getDateDiff(startDay, endDay, 'day') > 92){
			...
			location.href = "${ctx}/movieSearchRank/exportData.action?" + params
