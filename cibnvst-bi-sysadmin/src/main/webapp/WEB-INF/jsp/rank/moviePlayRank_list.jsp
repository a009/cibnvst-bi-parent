	...
	<div class="wrapper">
		...
		<div class="content-wrapper" style="background-color: #ecf0f5;">
			...
			<div class="content-roll">
				<form action="${ctx}/moviePlayRank/findMoviePlayRank.action" id="listForm" method="post">
					<%@include file="../share/sharForm.jsp"%>
					<section class="content-header">
						<i class="fa fa-home"></i>
						<a href="${ctx}/sysMain/index.action">首页</a>
						<span> > 排行统计 > 影片播放统计</span>
					</section>
...
<script type="text/javascript">
	...
	function ajaxGetCutPage(){
		...
		$.ajax({
			...
			async : true,
			cache : false,
			url:"${ctx}/moviePlayRank/ajaxGetCutPage.action",
			dataType:"json",
	...
	function showTable(msg){
		...
		$.each(data,function(i,n){
			...
			table += "<td>"+toString(n.vst_mp_uuid)+"</td>";
			table += "<td title='"+n.vst_mp_name+"'>"+toString(n.vst_mp_name)+"</td>";
			table += "<td>"+formatNumber(n.vst_mp_vv)+"</td>";
	...
	function button_export(){
		...
		if(!isNotEmpty(startDay) || !isNotEmpty(endDay) || getDateDiff(startDay, endDay, 'day') > 92){
			...
			location.href = "${ctx}/moviePlayRank/exportData.action?" + params
