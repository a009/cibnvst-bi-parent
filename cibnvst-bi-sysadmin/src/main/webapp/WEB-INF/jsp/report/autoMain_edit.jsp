	...
	<div class="wrapper">
		...
		<div class="content-wrapper">
			<div class="content-roll">
				<form id="listForm" action="${ctx}/autoMain/editAutoMain.action" method="post" enctype="multipart/form-data">
					<input type="hidden" name="vst_main_id" value="${formMap.vst_main_id }" />
					<input type="hidden" id="old_code" value="${formMap.vst_code }" />
					<%@include file="../share/sharForm.jsp"%>
					<section class="content-header">
						<i class="fa fa-home"></i>
						<a href="${ctx}/sysMain/index.action">首页</a>
						<span> > 自动化管理 > 自动化(主表)修改</span>
					</section>
						...
						<div id="move">
							<ul id='example2' class="line03">
								...
								<li>
									...
									<div class="add_m">
										<div class="add_m_l">
											<textarea class="input" id="vst_main_script" name="vst_main_script"
												style="height: 100px;" placeholder="请输入脚本">${formMap.vst_main_script }</textarea>
										</div>
										<div class="add_m_r">
											<span class="red">*</span>
										</div>
								...
								<li>
									...
									<div class="add_m">
										<div class="add_m_l">
											<input type="hidden" id="hidden_main_isPaging" value="${formMap.vst_main_isPaging }" />
								...
								<li id="countScript_li">
									...
									<div class="add_m">
										<div class="add_m_l">
											<textarea class="input" id="vst_main_countScript" name="vst_main_countScript"
												style="height: 100px;" placeholder="请输入分页脚本">${formMap.vst_main_countScript }</textarea>
										</div>
										<div class="add_m_r">
								...
								<li>
									...
									<div class="add_m">
										<div class="add_m_l">
											<input type="text" class="input" id="vst_main_index" name="vst_main_index" value="${formMap.vst_main_index }" placeholder="请输入排序,排序越小越靠前" />
										</div>
										<div class="add_m_r">
											<span class="red">*</span>
										</div>
								...
								<li>
									...
									<div class="add_m">
										<div class="add_m_l">
											<textarea class="input" id="vst_main_summary" name="vst_main_summary"
												style="resize: none; height: 100px;" placeholder="请输入描述">${formMap.vst_main_summary }</textarea>
										</div>
										<div class="add_m_r">
