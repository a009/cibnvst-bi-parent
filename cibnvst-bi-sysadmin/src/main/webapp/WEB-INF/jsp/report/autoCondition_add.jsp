	...
	<div class="wrapper">
		...
		<div class="content-wrapper">
			<div class="content-roll">
				<form id="listForm" action="${ctx}/autoCondition/addAutoCondition.action" method="post" enctype="multipart/form-data">
					<%@include file="../share/sharForm.jsp"%>
					<section class="content-header">
						<i class="fa fa-home"></i>
						<a href="${ctx}/sysMain/index.action">首页</a>
						<span> > 自动化管理 > 自动化(条件)新增</span>
					</section>
						...
						<div id="move">
							<ul id='example2' class="line03">
								...
								<li>
									...
									<div class="add_m">
										<div class="add_m_l">
											<input type="text" class="input" id="vst_condition_arg" name="vst_condition_arg" placeholder="请输入参数" />
										</div>
										<div class="add_m_r">
											<span class="red">*</span>
										</div>
								...
								<li>
									...
									<div class="add_m">
										<div class="add_m_l">
											<textarea class="input" id="vst_condition_script" name="vst_condition_script" style="height: 100px;" placeholder="请输入脚本"></textarea>
										</div>
										<div class="add_m_r">
											<span class="red">*</span>
										</div>
								...
								<li>
									...
									<div class="add_m">
										<div class="add_m_l">
											<input type="text" class="input" id="vst_condition_type" name="vst_condition_type" placeholder="string,int,double,date" />
										</div>
										<div class="add_m_r">
								...
								<li>
									...
									<div class="add_m">
										<div class="add_m_l">
											<input type="text" class="input" id="vst_condition_index" name="vst_condition_index" value="0" placeholder="请输入排序,排序越小越靠前" />
										</div>
										<div class="add_m_r">
											<span class="red">*</span>
										</div>
								...
								<li>
									...
									<div class="add_m">
										<div class="add_m_l">
											<textarea class="input" id="vst_condition_summary" name="vst_condition_summary" style="resize: none; height: 100px;" placeholder="请输入描述"></textarea>
										</div>
										<div class="add_m_r">
