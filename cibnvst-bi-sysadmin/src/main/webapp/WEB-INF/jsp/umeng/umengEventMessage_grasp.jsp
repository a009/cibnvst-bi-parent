...
<script type="text/javascript">
	$(function(){
		...
		if(queryParam == null || queryParam == ''){
			...
			$("#eventName").val('${queryParam.eventName}');
	...
	<div class="wrapper">
		...
		<div class="content-wrapper">
			<div class="content-roll">
				<form id="listForm" action="${ctx}/umengEventMessage/graspData.action" method="post">
					<%@include file="../share/sharForm.jsp"%>
					<section class="content-header">
						<i class="fa fa-home"></i>
						<a href="${ctx}/sysMain/index.action">首页</a>
						<span> > 友盟数据 > 事件消息抓取</span>
					</section>
					...
					<div class="body-content">
						<div id="move">
							<ul id='example2' class="line03">
								...
								<li>
									<div class="add_l">事件名称：</div>
									<div class="add_m">
										<div class="add_m_l">
											<select class="input" id="eventName" name="eventName">
