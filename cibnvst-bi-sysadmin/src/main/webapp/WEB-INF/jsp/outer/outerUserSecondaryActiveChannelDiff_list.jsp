...
<div class="wrapper">
	...
	<div class="content-wrapper" style="background-color: #ecf0f5;">
		<div class="content-roll">
			<form action="${ctx}/outerUserSecondaryActiveChannelDiff/findOuterUserSecondaryActiveChannelDiff.action" id="listForm" method="post">
				<%@include file="../share/sharForm.jsp"%>
				<section class="content-header">
					<i class="fa fa-home"></i>
					<a href="${ctx}/sysMain/index.action">首页</a>
					<span> > 市场数据 > 二次活跃渠道用户(对外)统计
...
<script type="text/javascript">
	...
	function ajaxGetReport(){
		...
		$.ajax({
			...
			async : true,
			cache : false,
			url : "${ctx}/outerUserSecondaryActiveChannelDiff/ajaxGetReportByDate.action",
			dataType : "json",
	...
	function ajaxGetCutPage(){
		...
		$.ajax({
			...
			async : true,
			cache : false,
			url : "${ctx}/outerUserSecondaryActiveChannelDiff/ajaxGetCutPage.action",
			dataType : "json",
			success : function(msg){
	...
	function showTable(msg){
		...
		table += "<th width='10%'><a onclick='changeOrder(this)' orderBy='vst_usacd_channel' id='vst_usacd_channel2' order='desc'>渠道</a></th>";
		table += "<th width='15%'><a onclick='changeOrder(this)' orderBy='vst_usacd_new_amount' id='vst_usacd_new_amount2' order='desc'>二次活跃用户</a></th>";
		...
		$.each(data,function(i,n){
			...
			table += "<td>"+toString(n.vst_usacd_channel)+"</td>";
	...
	function button_export(){
		...
		if(!isNotEmpty(startDay) || !isNotEmpty(endDay) || getDateDiff(startDay, endDay, 'day') > 92){
			...
			location.href = "${ctx}/outerUserSecondaryActiveChannelDiff/exportData.action?" + params
