	...
	<div class="wrapper">
		...
		<div class="content-wrapper" style="background-color: #ecf0f5;">
			<div class="content-roll">
				<form action="${ctx}/outerUserLevelChannel/findOuterUserLevelChannel.action" id="listForm" method="post">
					<%@include file="../share/sharForm.jsp"%>
					<section class="content-header">
						<i class="fa fa-home"></i>
						<a href="${ctx}/sysMain/index.action">首页</a>
						<span> > 市场数据 > 季质量渠道用户(对外)统计
...
<script type="text/javascript">
	...
	function ajaxGetReport(){
		...
		$.ajax({
			...
			async : true,
			cache : false,
			url:"${ctx}/outerUserLevelChannel/ajaxGetReportByDate.action",
			dataType:"json",
	...
	function ajaxGetCutPage(){
		...
		$.ajax({
			...
			async : true,
			cache : false,
			url:"${ctx}/outerUserLevelChannel/ajaxGetCutPage.action",
			dataType:"json",
			success:function(msg){
	...
	function showTable(msg){
		...
		table += "<th width='10%'><a onclick='changeOrder(this)' orderBy='vst_ulc_channel' id='vst_ulc_channel2' order='desc'>渠道</a></th>";
		table += "<th width='15%'><a onclick='changeOrder(this)' orderBy='vst_ulc_add_amount' id='vst_ulc_add_amount2' order='desc'>季新增用户</a></th>";
		table += "<th width='15%'><a onclick='changeOrder(this)' orderBy='vst_ulc_season_amount' id='vst_ulc_season_amount2' order='desc'>季质量用户</a></th>";
		table += "<th width='15%'><a onclick='changeOrder(this)' orderBy='vst_ulc_season_radio' id='vst_ulc_season_radio2' order='desc'>占比</a></th>";
		...
		$.each(data,function(i,n){
			...
			table += "<td>"+toString(n.vst_ulc_channel)+"</td>";
			//季新增用户
			table += "<td>"+formatNumber(n.vst_ulc_add_amount)+"</td>";
			//季质量用户
			table += "<td>"+formatNumber(n.vst_ulc_season_amount)+"</td>";
			//占比
	...
	function button_export(){
		...
		if(!isNotEmpty(startDay) || !isNotEmpty(endDay) || getDateDiff(startDay, endDay, 'day') > 92){
			...
			location.href = "${ctx}/outerUserLevelChannel/exportData.action?" + params
