...
define("ace/ace", ["require", "exports", "module", "ace/lib/fixoldbrowsers", "ace/lib/dom", "ace/lib/event", "ace/editor", "ace/edit_session", "ace/undomanager", "ace/virtual_renderer", "ace/multi_select", "ace/worker/worker_client", "ace/keyboard/hash_handler", "ace/placeholder", "ace/mode/folding/fold_mode", "ace/config"],
function(e, t, n) {
...
define("ace/lib/event", ["require", "exports", "module", "ace/lib/keys", "ace/lib/useragent", "ace/lib/dom"],
function(e, t, n) {
	function o(e, t, n) {
	...
	t.addMouseWheelListener = function(e, n) {
		var r = 8,
		i = function(e) {
			e.wheelDelta !== undefined ? e.wheelDeltaX !== undefined ? (e.wheelX = -e.wheelDeltaX / r, e.wheelY = -e.wheelDeltaY / r) : (e.wheelX = 0, e.wheelY = -e.wheelDelta / r) : e.axis && e.axis == e.HORIZONTAL_AXIS ? (e.wheelX = (e.detail || 0) * 5, e.wheelY = 0) : (e.wheelX = 0, e.wheelY = (e.detail || 0) * 5),
			n(e)
		};
...
function(e, t, n) {
	...
	g = function(e, t) {
		...
		this.$updateHighlightActiveLine = function() {
			...
			e.$highlightLineMarker && !t ? (e.removeMarker(e.$highlightLineMarker.id), e.$highlightLineMarker = null) : !e.$highlightLineMarker && t ? e.$highlightLineMarker = e.highlightLines(t.row, t.row, "ace_active-line") : t && (e.$highlightLineMarker.start.row = t.row, e.$highlightLineMarker.end.row = t.row, e._emit("changeBackMarker"))
		},
		...
		this.insert = function(e) {
			...
			if (!this.selection.isEmpty()) r = this.session.remove(this.getSelectionRange()),
			this.clearSelection();
			...
			if (t.getDocument().isNewLine(e)) {
				...
				for (var v = r.row + 1; v <= l.row; ++v) {
					var m = 0;
					a = t.getLine(v);
					for (var g = 0; g < a.length; ++g) if (a.charAt(g) == "	") m += p;
					else {
						if (a.charAt(g) != " ") break;
						m += 1
					}
		...
		this.transposeLetters = function() {
			...
			r,
			i;
			t < n.length ? (r = n.charAt(t) + n.charAt(t - 1), i = new h(e.row, t - 1, e.row, t + 1)) : (r = n.charAt(t - 1) + n.charAt(t - 2), i = new h(e.row, t - 2, e.row, t)),
...
define("ace/keyboard/textinput", ["require", "exports", "module", "ace/lib/event", "ace/lib/useragent", "ace/lib/dom", "ace/lib/lang"],
function(e, t, n) {
	var r = e("../lib/event"),
	i = e("../lib/useragent"),
	s = e("../lib/dom"),
	...
	a = function(e, t) {
		...
		k = function(e) {
			c ? (b(), e && t.onPaste(e), c = !1) : e == a[0] ? t.execCommand("del", {
				source: "ace"
			}) : (e.substring(0, 2) == a ? e = e.substr(2) : e[0] == a[0] ? e = e.substr(1) : e[e.length - 1] == a[0] && (e = e.slice(0, -1)), e[e.length - 1] == a[0] && (e = e.slice(0, -1)), e && t.onTextInput(e))
		},
		L = function(e) {
			if (h) return;
			var t = n.value;
		...
		i.isGecko || r.addListener(n, "contextmenu",
		function(e) {
...
define("ace/mouse/mouse_handler", ["require", "exports", "module", "ace/lib/event", "ace/lib/useragent", "ace/mouse/default_handlers", "ace/mouse/default_gutter_handler", "ace/mouse/mouse_event", "ace/mouse/dragdrop"],
function(e, t, n) {
	var r = e("../lib/event"),
	i = e("../lib/useragent"),
...
define("ace/mouse/default_handlers", ["require", "exports", "module", "ace/lib/dom", "ace/lib/useragent"],
function(e, t, n) {
	function o(e) {
	...
	s = 5; (function() {
		this.onMouseDown = function(e) {
			...
			if (t && !r.isFocused()) {
				r.focus();
				if (this.$focusWaitTimout && !this.$clickSelection) return this.setState("focusWait"),
				this.captureMouse(e),
				e.preventDefault()
			}
			return ! t || this.$clickSelection || e.getShiftKey() ? this.startSelect(n) : t && (this.mousedownEvent.time = (new Date).getTime(), this.setState("dragWait")),
			this.captureMouse(e),
			e.preventDefault()
		},
		...
		this.focusWait = function() {
			...
			t = (new Date).getTime(); (e > s || t - this.mousedownEvent.time > this.$focusWaitTimout) && this.startSelect()
		},
...
define("ace/mouse/default_gutter_handler", ["require", "exports", "module", "ace/lib/dom", "ace/lib/event"],
function(e, t, n) {
	function s(e) {
		function f() {
...
define("ace/mouse/dragdrop", ["require", "exports", "module", "ace/lib/event"],
function(e, t, n) {
	var r = e("../lib/event"),
	i = function(e) {
		var t = e.editor,
...
define("ace/edit_session", ["require", "exports", "module", "ace/config", "ace/lib/oop", "ace/lib/lang", "ace/lib/net", "ace/lib/event_emitter", "ace/selection", "ace/mode/text", "ace/range", "ace/document", "ace/background_tokenizer", "ace/search_highlight", "ace/edit_session/folding", "ace/edit_session/bracket_match"],
function(e, t, n) {
	var r = e("./config"),
	i = e("./lib/oop"),
	s = e("./lib/lang"),
	...
	d = function(e, t) {
		...
		this.$onChangeMode = function(e, t) {
			...
			t || (this.$modeId = e.$id, this.$setFolding(e.foldingRules), this._emit("changeMode"), this.bgTokenizer.start(0))
		},
		...
		this.$getUndoSelection = function(e, t, n) {
			...
			r(i) ? (o = i.range.start, s.compare(o.row, o.column) == -1 && s.setStart(i.range.start), o = i.range.end, s.compare(o.row, o.column) == 1 && s.setEnd(i.range.end), u = !0) : (o = i.range.start, s.compare(o.row, o.column) == -1 && (s = l.fromPoints(i.range.start, i.range.start)), u = !1);
			if (n != null) {
		...
		this.moveText = function(e, t) {
			...
			this.remove(e);
			var r = t.row,
			i = t.column; ! e.isMultiLine() && e.start.row == r && e.end.column < i && (i -= n.length);
		...
		this.setWrapLimitRange = function(e, t) {
			if (this.$wrapLimitRange.min !== e || this.$wrapLimitRange.max !== t) this.$wrapLimitRange.min = e,
		...
		this.$updateWrapData = function(e, t) {
			...
			while (c <= t) {
				...
				if (!l) f = this.$getDisplayTokens(s.stringTrimRight(n[c])),
...
define("ace/config", ["require", "exports", "module", "ace/lib/lang", "ace/lib/oop", "ace/lib/net", "ace/lib/event_emitter"],
function(e, t, n) {
	"no use strict";
	function f(e) {
		return e.replace(/-(.)/g,
	...
	t.moduleUrl = function(e, t) {
		...
		var n = e.split("/");
		t = t || n[n.length - 2] || "";
		var r = n[n.length - 1].replace(t, "").replace(/(^[\-_])|([\-_]$)/, ""); ! r && n.length > 1 && (r = n[n.length - 2]);
		var i = a[t + "Path"];
...
define("ace/lib/net", ["require", "exports", "module", "ace/lib/useragent"],
function(e, t, n) {
	var r = e("./useragent");
	t.get = function(e, n) {
		var r = t.createXhr();
...
define("ace/mode/text", ["require", "exports", "module", "ace/tokenizer", "ace/mode/text_highlight_rules", "ace/mode/behaviour", "ace/unicode"],
function(e, t, n) {
	...
	var r = function(e, t) {
		...
		for (var n in this.states) {
			...
			for (var u = 0; u < r.length; u++) {
				...
				Array.isArray(a.token) && (a.token.length == 1 ? a.token = a.token[0] : (a.tokenArray = a.token, a.token = this.$arrayTokens)),
				l > 1 && (/\\\d/.test(a.regex) ? f = a.regex.replace(/\\([0-9]+)/g,
				function(e, t) {
					return "\\" + (parseInt(t, 10) + s + 1)
				}) : (l = 1, f = this.removeCapturingGroups(a.regex)), a.splitRegex || (a.splitRegex = this.createSplitterRegexp(a.regex, t))),
				o[s] = u,
				s += l,
				i.push(f)
			}
		...
		this.$arrayTokens = function(e) {
			...
			for (var i = 0; i < r.length; i++) t[i + 1] && (n[n.length] = {
				type: r[i],
				value: t[i + 1]
			});
			return n
		...
		this.getLineTokens = function(e, t) {
			...
			while (u = o.exec(e)) {
				...
				if (d - p.length > f) {
					...
					l.type == c ? l.value += v: (l.type && a.push(l), l = {
						type: c,
						value: v
					})
				}
				for (var m = 0; m < u.length - 2; m++) {
					...
					h.next && (r = h.next, i = this.states[r], i || (window.console && console.error && console.error(r, "doesn't exist"), r = "start", i = this.states[r]), s = this.matchMappings[r], f = d, o = this.regExps[r], o.lastIndex = d);
					break
				}
...
define("ace/document", ["require", "exports", "module", "ace/lib/oop", "ace/lib/event_emitter", "ace/range", "ace/anchor"],
function(e, t, n) {
	var r = e("./lib/oop"),
	...
	u = function(e) {
		...
		this.$clipPosition = function(e) {
			var t = this.getLength();
			return e.row >= t && (e.row = Math.max(0, t - 1), e.column = this.getLine(t - 1).length),
			e
		},
		this.insert = function(e, t) {
			...
			i !== null && (e = this.insertNewLine(e), e = this.insertLines(e.row, n), e = this.insertInLine(e, i || "")),
			e
		},
...
function(e, t, n) {
	...
	s = t.Anchor = function(e, t, n) {
		...
		this.onChange = function(e) {
			...
			var r = this.row,
			i = this.column;
			t.action === "insertText" ? n.start.row === r && n.start.column <= i ? n.start.row === n.end.row ? i += n.end.column - n.start.column: (i -= n.start.column, r += n.end.row - n.start.row) : n.start.row !== n.end.row && n.start.row < r && (r += n.end.row - n.start.row) : t.action === "insertLines" ? n.start.row <= r && (r += n.end.row - n.start.row) : t.action == "removeText" ? n.start.row == r && n.start.column < i ? n.end.column >= i ? i = n.start.column: i = Math.max(0, i - (n.end.column - n.start.column)) : n.start.row !== n.end.row && n.start.row < r ? (n.end.row == r && (i = Math.max(0, i - n.end.column) + n.start.column), r -= n.end.row - n.start.row) : n.end.row == r && (r -= n.end.row - n.start.row, i = Math.max(0, i - n.end.column) + n.start.column) : t.action == "removeLines" && n.start.row <= r && (n.end.row <= r ? r -= n.end.row - n.start.row: (r = n.start.row, i = 0)),
...
function(e, t, n) {
	...
	o = function(e, t) {
		...
		this.$tokenizeRow = function(e) {
			...
			return r && (i.tokens.push(r), i.state = "start"),
			this.states[e] + "" != i.state + "" ? (this.states[e] = i.state, this.lines[e + 1] = null, this.currentLine > e + 1 && (this.currentLine = e + 1)) : this.currentLine == e && (this.currentLine = e + 1),
...
function(e, t, n) {
	function u() {
		...
		this.onFoldWidgetClick = function(e, t) {
			...
			} else s && this.foldAll(e + 1, this.getLength()),
...
define("ace/edit_session/fold", ["require", "exports", "module"],
function(e, t, n) {
...
define("ace/keyboard/hash_handler", ["require", "exports", "module", "ace/lib/keys"],
function(e, t, n) {
	function i(e, t) {
		this.platform = t,
		this.commands = {},
...
define("ace/commands/default_commands", ["require", "exports", "module", "ace/lib/lang", "ace/config"],
function(e, t, n) {
	function s(e, t) {
		return {
			win: e,
...
function(e, t, n) {
	var r = function() {
		...
		this.undo = function(e) {
			...
			n = null;
			return t && (n = this.$doc.undoChanges(t, e), this.$redoStack.push(t)),
			n
		},
		this.redo = function(e) {
			var t = this.$redoStack.pop(),
			n = null;
			return t && (n = this.$doc.redoChanges(t, e), this.$undoStack.push(t)),
			n
		},
		this.reset = function() {
			this.$undoStack = [],
...
define("ace/virtual_renderer", ["require", "exports", "module", "ace/lib/oop", "ace/lib/dom", "ace/lib/event", "ace/lib/useragent", "ace/config", "ace/lib/net", "ace/layer/gutter", "ace/layer/marker", "ace/layer/text", "ace/layer/cursor", "ace/scrollbar", "ace/renderloop", "ace/lib/event_emitter"],
function(e, t, n) {
	var r = e("./lib/oop"),
	i = e("./lib/dom"),
	s = e("./lib/event"),
	...
	var g = function(e, t) {
		...
		this.onResize = function(e, t, n, r) {
			...
			r && (e || o.height != r) && (o.height = r, o.scrollerHeight = this.scroller.clientHeight, this.scrollBar.setHeight(o.scrollerHeight), this.session && (this.session.setScrollTop(this.getScrollTop()), s |= this.CHANGE_FULL)),
		...
		this.$renderChanges = function(e, t) {
			if (!t && (!e || !this.session || !this.container.offsetWidth)) return; (e & this.CHANGE_FULL || e & this.CHANGE_SIZE || e & this.CHANGE_TEXT || e & this.CHANGE_LINES || e & this.CHANGE_SCROLL) && this.$computeLayerConfig();
		...
		this.$computeLayerConfig = function() {
			...
			this.$horizScroll = i,
			s && (this.scroller.style.overflowX = i ? "scroll": "hidden", i || this.session.setScrollLeft(0));
...
function(e, t, n) {
	...
	u = function(e) {
		...
		this.update = function(e) {
			...
			d += v.left + v.right,
			d !== this.gutterWidth && (this.gutterWidth = d, this.element.style.width = Math.ceil(this.gutterWidth) + "px", this._emit("changeGutterWidth", d))
		},
...
function(e, t, n) {
	...
	s = function(e) {
		...
		this.drawTextMarker = function(e, t, n, i) {
			...
			for (s = t.start.row + 1; s < t.end.row; s++) o.start.row = s,
			o.end.row = s,
...
function(e, t, n) {
	...
	a = function(e) {
		...
		this.onChangeTabSize = this.$computeTabString = function() {
			...
			for (var n = 1; n < e + 1; n++) this.showInvisibles ? t.push("<span class='ace_invisible'>" + this.TAB_CHAR + s.stringRepeat("聽", n - 1) + "</span>") : t.push(s.stringRepeat("聽", n));
			if (this.displayIndentGuides) {
				...
				if (this.showInvisibles) {
					...
					o = this.TAB_CHAR + s.stringRepeat("聽", this.tabSize - 1)
				} else var i = s.stringRepeat("聽", this.tabSize),
				o = i;
		...
		this.$renderToken = function(e, t, n, r) {
			...
			u = function(e, n, r, o, u) {
				if (n) return i.showInvisibles ? "<span class='ace_invisible'>" + s.stringRepeat(i.SPACE_CHAR, e.length) + "</span>": s.stringRepeat("聽", e.length);
				if (e == "&") return "&#38;";
				if (e == "<") return "&#60;";
				if (e == "	") {
...
define("ace/multi_select", ["require", "exports", "module", "ace/range_list", "ace/range", "ace/selection", "ace/mouse/multi_select_handler", "ace/lib/event", "ace/lib/lang", "ace/commands/multi_select_commands", "ace/search", "ace/edit_session", "ace/editor"],
function(e, t, n) {
	function h(e, t, n) {
	...
	var d = e("./editor").Editor; (function() {
		...
		this.$onMultiSelectExec = function(e) {
			...
			t.multiSelectAction ? t.multiSelectAction == "forEach" ? n.forEachSelection(t, e.args) : t.multiSelectAction == "single" ? (n.exitMultiSelectMode(), t.exec(n, e.args || {})) : t.multiSelectAction(n, e.args || {}) : (t.exec(n, e.args || {}), n.multiSelect.addRange(n.multiSelect.toOrientedRange()), n.multiSelect.mergeOverlappingRanges()),
			e.preventDefault()
		},
		this.forEachSelection = function(e, t) {
			...
			for (var a = i.ranges.length; a--;) u.fromOrientedRange(i.ranges[a]),
...
define("ace/range_list", ["require", "exports", "module"],
function(e, t, n) {
	var r = function() {
		this.ranges = []
	}; (function() {
		...
		this.merge = function() {
			...
			for (var i = 1; i < t.length; i++) {
				...
				this.comparePoints(r.end, n.end) < 0 && (r.end.row = n.end.row, r.end.column = n.end.column),
				t.splice(i, 1),
				e.push(n),
				n = r,
				i--
		...
		this.$onChange = function(e) {
			...
			l = a.length; f < l; f++) {
				...
				c.start.row == i && c.start.column >= n.column && (c.start.column += u, c.start.row += o),
				c.end.row == i && c.end.column >= n.column && (c.end.column += u, c.end.row += o)
			}
...
define("ace/mouse/multi_select_handler", ["require", "exports", "module", "ace/lib/event"],
function(e, t, n) {
	function i(e, t) {
		return e.row == t.row && e.column == t.column
	}
...
define("ace/worker/worker_client", ["require", "exports", "module", "ace/lib/oop", "ace/lib/event_emitter", "ace/config"],
function(e, t, n) {
	var r = e("../lib/oop"),
	i = e("../lib/event_emitter").EventEmitter,
	s = e("../config"),
...
define("ace/mode/json", ["require", "exports", "module", "ace/lib/oop", "ace/mode/text", "ace/tokenizer", "ace/mode/json_highlight_rules", "ace/mode/matching_brace_outdent", "ace/mode/behaviour/cstyle", "ace/mode/folding/cstyle", "ace/worker/worker_client"],
function(e, t, n) {
	var r = e("../lib/oop"),
	i = e("./text").Mode,
